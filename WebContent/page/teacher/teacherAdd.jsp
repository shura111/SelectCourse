...
<body class="childrenBody">
			...
			%>
	<form class="" action="<%=path %>/AddTeacherServlet" method="post" onSubmit="return check();">
		<div class="x-body layui-anim layui-anim-up">
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="tname" name="tname" value="" required="required" maxlength=10 onkeyup="this.value=this.value.replace(/(^\s+)|(\s+$)/g,'');"
                    class="layui-input" />
              </div>    
          </div>
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="number" id="tage" name="tage" value="" required="required"
                   class="layui-input" />
              </div>    
          </div>
          <div class="layui-form-item">
	...
	$.ajax({
		...
		success : function(tacademy) {
			if(tacademy.length>0){
			 	$("#tacademy").empty();
				$("#tacademy").append("<option>"+"--请选择学院--"+"</option>");
				$("#toffice").append("<option>"+"--请选择办公室--"+"</option>");
 		}
	...
	function check(){ 
		...
		var options=$("#tacademy option:selected");
		var s=options.text();
		if(s=="--请选择学院--"){ 
			layer.alert('请选择学院!');
			return false;
